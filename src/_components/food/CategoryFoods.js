...
// {foods.map((food) => {
//   // map дотор variable-г тодорхойлно
//   const categoryObj = categories?.find(cat => cat._id === food.categoryId);
...
//     food={selectedFood}
//     categories={
//       categories?.find(cat => cat._id === selectedFood.categoryId)
//     } // selectedFood-д харгалзах category-ийг энд олж дамжуулж байна
//   />
// )}
// };
...
export default function FoodEditDialog({ open, setOpen, food, setFood, addToCart, categories }) {
        ...
        <div className=" relative">
          <div className="flex flex-col gap-[8px]">
            ...
            <div className="flex flex-row justify-between mb-3">
              <p className="text-gray-400 text-xs font-normal leading-4 font-inter">Dish name</p>
              <Input
                type="text"
                value={food.foodName}
            ...
            <div className="flex flex-row justify-between mb-3">
              <p className="text-gray-400 text-xs font-normal leading-4 font-inter">Dish category</p>
              <Input
                type="text"
                value={food.category}
            ...
            <div className="flex flex-row mb-3">
              <p className="text-gray-400 text-xs font-normal leading-4 font-inter">Ingredients</p>
              <textarea
            ...
            <div className="flex flex-row justify-between mb-3">
              <p className="text-gray-400 text-xs font-normal leading-4 font-inter">Price</p>
              <Input
                type="text"
                value={food.price}
            ...
            <div className="flex flex-row justify-between items-start mb-6">
              <p className="text-gray-400 text-xs font-normal leading-4 font-inter">Image</p>
